---
title: ミニマルな「時報の読み上げサービス」の開発：Next.js と Web Speech API
...
今回は、指定した間隔で現在時刻を音声でお知らせするシンプルなWebアプリ「[Time Call Service](https://time-call-web-v1.vercel.app)」を開発したので、その技術的なポイントやこだわりを紹介します。
