...
const PROJECTS = [
  {
    ...
    description: '指定したURLからOGPを取得、ブログにリンクカードを簡単に追加できるサービス。',
  },
  {
    href: 'https://time-call-web-v1.vercel.app',
    title: 'Time Call Web',
    description: 'シンプルな時報通知アプリ。時報は音声でお知らせ。1分〜60分間隔で設定が可能。',
  },
  {
    href: 'https://tiny-calc-894742994238.asia-northeast1.run.app',
    title: 'Tiny Calc',
    description: 'ミニマルなターミナルスタイルの電卓。計算履歴の保存と再利用ができます。',
  },
];

export default createRoute((c) => {
  const title = 'Poko Hanada';
  const description = 'Webディレクター兼デベロッパー、Poko Hanadaのポートフォリオサイトです。';
  ...
  return c.render(
    <div>
      ...
      <Section heading='About' id='about'>
        ...
        <div class='mb-3'>
          <Button href='https://github.com/poko8nada' variant='primary' target='_blank'>
            Github
          </Button>
        </div>
        <div>
          <Button href='https://x.com/you88451h' variant='primary' target='_blank'>
            X/Twitter
          </Button>
        </div>
        <div class='mt-8'>
